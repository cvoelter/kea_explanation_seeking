...
```{r echo=FALSE}
p.con.power <- ggplot(data = lrt.data2, aes(x= as.factor(int.per),y = proportion.sign.lrt.con, fill=as.factor(fun.per))) +
...
ggsave(p.con.power, filename = "graphics/kea_explanation_seeking_power_8trials_16subj.png", scale = 0.7, height = 5, width = 8)
```
