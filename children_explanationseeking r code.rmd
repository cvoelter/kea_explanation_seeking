...
#peeking yes no
ggplot(data = peeking_data_agg_trial3, aes(x = trial_overall, y = peeking_response_binary_summed)) +
...
next steps: repeat analysis with excluded child 112 and make sure that the relevant coding time is ok. 
next analyses: we cannot really analyse the asking why variable because only two subjects showed this response but we can analyse the proportion peeking duration variable once we have decided on the relevant period for coding.
